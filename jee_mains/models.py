...
class jee_mains(models.Model): 
    ...
    option1  = models.TextField(default="", null=True)
    option2  = models.TextField(default="", null=True)
    option3  = models.TextField(default="", null=True)
    option4  = models.TextField(default="", null=True)
